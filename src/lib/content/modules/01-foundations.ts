    ...
    checks: [
      {
        ...
        type: "includesAny",
        value: ["summary", "summarize", "describes", "explained", "overview", "read", "file", "exports", "component"],
      },
      {
        id: "mentions-command",
        description: "Mentions a command that was run (e.g. test, ls, git, npm, build)",
        type: "includesAny",
        value: ["test", "ls", "git", "npm", "build", "run", "yarn", "pnpm", "cli", "terminal", "script"],
      },
      {
      ...
      },
      {
        ...
        type: "includesAny",
        value: ["edit", "change", "added", "fixed", "wrote", "updated", "modify", "modified", "tweak", "comment"],
      },
    ],
  },
};
