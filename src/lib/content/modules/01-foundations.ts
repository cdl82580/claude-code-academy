  ...
  lessonSections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Because these actions can change your filesystem or execute code, Claude Code asks for your permission before taking actions outside a safe default set (see Module 4 for the full permissions model). Early on, expect to see and approve individual file edits and commands — this is a feature, not friction: it's your checkpoint to catch a misunderstanding before it becomes a wasted diff.",
