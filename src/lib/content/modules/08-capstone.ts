    ...
    checks: [
      {
        ...
        type: "includesAny",
        value: ["plan", "approach", "scoped it", "laid out"],
      },
      {
        id: "has-test-evidence",
        description: "Includes testing evidence",
        type: "includesAny",
        value: ["test", "tests", "testing"],
      },
      {
        id: "has-debug-evidence",
        description: "Includes debugging evidence",
        type: "includesAny",
        value: ["debug", "debugging", "bug", "issue"],
      },
      {
        id: "has-document",
        description: "Includes a documentation section",
        type: "includesAny",
        value: ["document", "readme", "claude.md", "documentation", "wrote up"],
      },
      {
