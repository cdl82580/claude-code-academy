    ...
    checks: [
      {
        ...
        type: "includesAny",
        value: ["about me", "experience", "preferred language", "stack", "background", "comfortable in", "years of"],
      },
      {
        id: "has-workflow-prefs",
        description: "Includes a workflow or communication preference",
        type: "includesAny",
        value: ["prefer", "always use", "workflow", "communication", "concise", "verbose", "habit", "default to", "style"],
      },
      {
